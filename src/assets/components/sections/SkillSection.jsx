...
// 🔹 Komponen Kartu Skill (reusable)
const SkillCard = ({ icon, name }) => {
  return (
    <div className="flex flex-col justify-center items-center h-32 w-64 rounded-md shadow-md border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-800 dark:text-white transition-all duration-300">
  ...
  return (
    <LayoutSection id="skill">
      ...
      <div data-aos="fade-up" className="text-center px-4">
        ...
        <p
          data-aos="fade-up"
          className="text-slate-500 dark:text-slate-300 text-base mt-2"
        >
          {skillData.subtitle}
        </p>
      </div>
      ...
      <div
        data-aos="fade-up"
        className="w-full flex justify-center mt-12 px-4 relative z-50"
      >
        <div className="relative" ref={dropdownRef}>
          ...
          {/* Dropdown List */}
          <div
            className={`absolute mt-2 w-full bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-md shadow-md transition-all duration-300 overflow-hidden ${
              isOpen
      ...
      <div
        data-aos="fade-down"
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8 place-items-center px-4 relative z-0"
      >
